...
// Open Graph 1200×630 — preview de link em WhatsApp, Telegram, LinkedIn,
// Twitter. Frame cinematográfico real (colheitadeira em campo dourado,
// golden hour, gerado via Kling 3.0) como background, overlay editorial
// preto-em-baixo, lockup AgroBridge canto sup-esq, tagline serif gigante
// canto inf-esq, URL mono canto inf-dir. Bandeira dourada sutil no topo.
...
export default async function OpenGraphImage() {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Background photo — ImageResponse/Satori não aceita next/image */}
        ...
        {/* Vertical gradient overlay — escurece do topo, intensifica embaixo */}
        <div
          style={{
            position: 'absolute',
            inset: 0,
        ...
        {/* Side wash esquerda — destaca lockup */}
        <div
          style={{
            position: 'absolute',
            inset: 0,
