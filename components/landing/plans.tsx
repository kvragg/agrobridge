...
const PLANS: Plan[] = [
  {
    ...
    tagline: "Chegue na agência sabendo exatamente o que falar.",
    desc:
      "Leitura técnica do seu caso antes de qualquer reunião. Pra entender se vale ir ao banco agora ou ajustar antes.",
    features: [
      "Entrevista técnica completa com IA estratégica",
      "Diagnóstico tático em PDF — posicionamento bancário",
  ...
  },
  {
    ...
    desc:
      "Entrega completa: dossiê institucional montado pela consultoria especializada, no formato que o comitê de crédito espera ver.",
    features: [
      "Tudo do Diagnóstico Rápido",
      "Dossiê Bancário profissional em PDF",
      "Checklist 100% ordenado conforme MCR",
      "Validação por IA de cada documento anexado",
  ...
  {
    price: "1.497,00",
    name: "Assessoria Premium 1:1",
    tagline: "Acompanhamento pessoal direto com o fundador.",
    desc:
      "Para operações maiores ou quando a janela da safra não admite erro — sessão 1:1, revisão cirúrgica e parecer estratégico.",
    features: [
      "Tudo do Dossiê Completo",
      "Sessão 1:1 (45 min) com o fundador",
      "Revisão cirúrgica do seu dossiê",
      "Análise de gargalos ocultos antes do comitê ver",
      "Apenas 6 vagas por mês — vaga garantida",
      "Garantia incondicional de 7 dias",
    ],
