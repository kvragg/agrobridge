...
const FASES: FaseDef[] = [
  ...
  },
  {
    ...
    outcome: "Sabe o que falar — e o que não falar — no banco",
    features: [
  ...
  },
  {
    ...
    resumo: "Pedido pronto pra mesa do comitê",
    outcome: "Protocola no banco no formato que o analista defende",
    features: [
      "Dossiê profissional em PDF",
      "Sumário executivo + checklist 100% ordenado",
  ...
  },
  {
    ...
    resumo: "Revisão direta com quem sentou na mesa",
    outcome: "Tratativa 1:1 com o fundador até o banco aprovar",
    features: [
      "Consultoria pessoal com o fundador (14 anos no SFN)",
      "Revisão minuciosa do seu dossiê",
      "Gargalos ocultos identificados antes do comitê",
      "Alinhamento estratégico caso-a-caso",
    ],
    glow: "gold",
    accent: "gold",
  },
